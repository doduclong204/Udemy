    ...
    <footer className="bg-udemy-navy text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          {/* Column 1: About LearnHub */}
          <div>
            <h4 className="font-bold text-white text-lg mb-4">LearnHub</h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/how-to-learn" className="hover:text-white transition-colors">
                  Hướng dẫn học tập
                </Link>
              </li>
              <li>
                <Link to="/learning-tips" className="hover:text-white transition-colors">
                  Mẹo học hiệu quả
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/student-faq" className="hover:text-white transition-colors">
                  Câu hỏi thường gặp
                </Link>
              </li>
              <li>
                <Link to="/student-success" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">support@learnhub.vn</span>
              </div>
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-primary mt-0.5" />
                <span className="text-gray-300">Tầng 10, Tòa nhà ABC, Quận 1, TP.HCM</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-700 pt-8 gap-4">
          ...
          <p className="text-sm text-gray-400 text-center md:text-right">
            © 2025 LearnHub Việt Nam. Bảo lưu mọi quyền.
          </p>
        </div>
      </div>
    </footer>
