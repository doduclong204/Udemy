              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    currentPath === item.path || (item.path === '/dashboard' && currentPath === '/dashboard/my-learning')
              ...
              <div>
                ...
                {wishlistCourses.length > 0 ? (
                  ...
                  <div className="text-center py-16 bg-secondary rounded-lg">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Lưu các khóa học bạn quan tâm bằng cách nhấn biểu tượng trái tim.
                    </p>
                    <Link
                      to="/"
                      className="inline-block bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-udemy-purple-dark transition-colors"
              ...
              <div>
                ...
                <div className="max-w-2xl space-y-6">
                    ...
                    <div className="grid gap-4">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            defaultValue={user?.name?.split(' ').slice(0, -1).join(' ') || ''}
                  ...
                  <div className="bg-card border border-border rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                        ...
                        <button className="text-primary font-medium hover:underline text-sm">Liên kết</button>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                        <div className="flex items-center gap-3">
                  ...
                  <div className="bg-card border border-destructive rounded-lg p-6">
                    <h2 className="text-lg font-semibold text-destructive mb-2">Xóa tài khoản</h2>
